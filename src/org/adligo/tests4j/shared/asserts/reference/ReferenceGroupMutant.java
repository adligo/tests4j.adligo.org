...
public class ReferenceGroupMutant implements I_ReferenceGroup {
	private Map<String, ClassAttributesMutant> deps = new HashMap<String, ClassAttributesMutant>();

	public ReferenceGroupMutant() {
		
	}
	
	public ReferenceGroupMutant(I_ReferenceGroup other) {
	...
	public void intersect(I_ReferenceGroup other) {

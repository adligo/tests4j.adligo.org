...
public interface I_SourceFileTrial extends I_Trial {
	...
	public static final String TEST_DEPENDENCIES = 
			"testDependencies(I_SourceFileTrialResult trialResult)";
	public static final String TEST_REFERENCES = 
			"testReferences(I_SourceFileTrialResult trialResult)";
	public static final String TEST_MIN_COVERAGE =
			"testMinCoverage(I_SourceFileTrialResult trialResult)";
	/**

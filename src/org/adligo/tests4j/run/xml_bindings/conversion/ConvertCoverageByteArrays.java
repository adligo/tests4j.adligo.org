...
public class ConvertCoverageByteArrays {
  ...
  public static DataFromBytesMutant fromData(byte [] data) {
    ...
    byte [] cusBytes = Arrays.copyOfRange(data, 4, 8);
  ...
  /**
   * @param bytes an array of 4 bytes, any other size will throw a exception
   * @return
   */
  ...
  public static byte[] toBytes(int p) {

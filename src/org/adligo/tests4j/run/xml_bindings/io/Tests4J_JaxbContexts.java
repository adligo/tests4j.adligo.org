...
public class Tests4J_JaxbContexts {
    ...
    private static final String RUN_RESULTS_PKG = "org.adligo.tests4j.run.xml.io.trial_run_results";
    ...
    public static final String RUN_RESULTS_NS = getURI(RUN_RESULTS_PKG);
    ...
    public static final JAXBContext RUN_RESULTS_CONTEXT = getContext(RUN_RESULTS_PKG);

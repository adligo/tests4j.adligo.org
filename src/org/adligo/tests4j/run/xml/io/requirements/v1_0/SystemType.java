 ...
 *         &lt;element name="use_cases" type="{http://www.adligo.org/tests4j/run/xml/io/requirements/v1_0}use_cases_path_name_type" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class SystemType {
    ...
    @XmlElement(name = "use_cases")
    protected List<UseCasesPathNameType> useCases;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link UseCasesPathNameType }
     * 
     * 
     */
    public List<UseCasesPathNameType> getUseCases() {
        if (useCases == null) {
            useCases = new ArrayList<UseCasesPathNameType>();
        }

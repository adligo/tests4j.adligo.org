 ...
 * generated in the org.adligo.tests4j.run.xml.io.trial_run_result package. 
...
public class ObjectFactory {
    ...
    private final static QName _TrialRunResult_QNAME = new QName("http://www.adligo.org/tests4j/run/xml/io/trial_run_result", "trial_run_result");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.adligo.tests4j.run.xml.io.trial_run_result
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.adligo.org/tests4j/run/xml/io/trial_run_result", name = "trial_run_result")

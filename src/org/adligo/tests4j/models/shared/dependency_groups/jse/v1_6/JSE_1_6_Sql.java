 ...
 *
 */
public class JSE_1_6_Sql extends DependencyGroupBaseDelegate implements I_JSE_1_6_Sql, I_PackageConstantLookupModel {
	public static final String JAVA_SQL = "java.sql";
	private static final Map<String,String> CONSTANT_LOOKUP = getConstantLookup();
	public static final JSE_1_6_Sql INSTANCE = new JSE_1_6_Sql();

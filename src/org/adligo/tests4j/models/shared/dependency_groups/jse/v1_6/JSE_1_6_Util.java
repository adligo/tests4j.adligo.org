 ...
 *
 */
public class JSE_1_6_Util extends DependencyGroupBaseDelegate  implements I_JSE_1_6_Util, I_PackageConstantLookupModel {
	public static final String JAVA_UTIL = "java.util";
	private static final Map<String,String> CONSTANT_LOOKUP = getConstantLookup();
	public static final JSE_1_6_Util INSTANCE = new JSE_1_6_Util();
	
	private JSE_1_6_Util() {

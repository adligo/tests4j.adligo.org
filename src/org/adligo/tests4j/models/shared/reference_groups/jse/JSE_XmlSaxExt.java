 ...
 *
 */
public class JSE_XmlSaxExt extends ReferenceGroupBaseDelegate  implements I_JSE_1_8_XmlSax, I_PackageConstantLookupModel {
	public static final String ORG_XML_SAX_EXT = "org.xml.sax.ext";
	...
	public static final JSE_XmlSaxExt INSTANCE = new JSE_XmlSaxExt();
	
	private JSE_XmlSaxExt() {
    super.setDelegate(new NameOnlyReferenceGroup(CONSTANT_LOOKUP.keySet()));
  };
	
	private static Map<String,String> getConstantLookup() {
		Map<String,String> toRet = new HashMap<>(JSE_1_6_XmlSaxExt.INSTANCE.getModelMap());
		return toRet;
	}

	@Override
	public String getPackageName() {
		return ORG_XML_SAX_EXT;
	}

...
public class GWT_2_6_Util {
	...
	public static ClassAttributes getAbstractMap() {
		...
		addAbstractMapMembers(toRet, true);
		return new ClassAttributes(toRet);
	}

	/**
	 * @param toRet
	 * @param includeObjectObjectPut
	 *    as of 1.8 source enum map can't call put Object, Object from abstract map
	 */
	public static void addAbstractMapMembers(ClassAttributesMutant toRet, boolean includeObjectObjectPut) {
		GWT_2_6_Lang.addObjectMembers(toRet);
	...
	public static void addEnumMapMembers(ClassAttributesMutant toRet) {
		addAbstractMapMembers(toRet, false);
